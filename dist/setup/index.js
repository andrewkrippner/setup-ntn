...
var require_command_exists = __commonJS({
  "node_modules/command-exists/lib/command-exists.js"(exports, module) {
    ...
    var constants3 = fs3.constants || fs3;
    ...
    if (isUsingWindows) {
      cleanInput = function(s) {
        ...
        if (isPathName) {
          var dirname3 = '"' + path4.dirname(s) + '"';
          var basename3 = '"' + path4.basename(s) + '"';
          return dirname3 + ":" + basename3;
        }
        return '"' + s + '"';
      };
    }
    module.exports = function commandExists2(commandName, callback) {
      ...
      if (!callback && typeof Promise !== "undefined") {
        return new Promise(function(resolve2, reject) {
          commandExists2(commandName, function(error2, output) {
            if (output) {
...
var login = async () => {
  ...
  info(
    "Setting NOTION_KEYRING=0 so ntn uses file-based auth (no OS keychain on CI)"
  );
...
var install = async () => {
  ...
  if (!(0, import_command_exists.sync)("npm")) {
    throw new Error(
...
var printEnvDetailsAndSetOutput = async () => {
...
var getToolVersion = async (tool, options) => {
  try {
